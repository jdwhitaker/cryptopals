# from https://github.com/ajalt/python-sha1/blob/master/sha1.py
...
class Sha1Hash(object):
    ...
    def _produce_digest(self):
        ...
        self._pad += b'\x00' * ((56 - (message_byte_length + 1) % 64) % 64)

        # append length of message (before pre-processing), in bits, as 64-bit big-endian integer
        message_bit_length = message_byte_length * 8
        self._pad += struct.pack(b'>Q', message_bit_length)
        ...
        out = _process_chunk(message[64:], *h)
        return out
